...
@Autowired
    public Scheduler(Service service, NotificationRepo notificationRepo, Notification_content_repo notification_content_repo, UserRepository userRepo, EmailService emailService) {
...
//                        EmailDetails emailDetails = EmailDetails.builder().recipient(ele.getEmail()).subject("Résumé hebdomadaire des valeurs insérées : "+ getformatedDate(new Date()) ).build();
                        EmailDetails emailDetails = EmailDetails.builder().recipient("achraf.aouad@etu.uae.ac.ma").subject("Résumé hebdomadaire des valeurs insérées : "+ getformatedDate(new Date()) ).build();
